...
<p className="mt-2 text-sm text-gray-500 font-medium max-w-sm mx-auto">
    ...
    <div className="space-y-3 text-sm text-left font-medium">
      ...
      <Detail label="Pickup date" value={formatDate(booking.pickupDate)} />
      <Detail label="Drop-off date" value={formatDate(booking.dropoffDate)} />
    </div>
    ...
    <div className="space-y-2 text-sm text-left font-medium">
      ...
      <Amount label="Paid now" value={`AED ${booking.prepaymentAmount}`} />
      <Amount
